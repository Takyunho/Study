...
function init() {
  ...
  camera.position.set(1, 150, 120); //* 카메라 포지션 x, y, z
  scene.add(camera)
  ...
  // 차트 div박스
  let chartBox = makeElementObject('div', 250, 150);
  ...
  button.css3dObject.element.addEventListener('mouseover', () => { 
    ...
    chartBox.position.set(140, 0, 30)
  ...
  chartBox.css3dObject.element.addEventListener('mouseup', () => {
    chartBox.css3dObject.element.innerHTML = ""
