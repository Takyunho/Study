...
function init() {
  ...
  camera.position.set(0, 100, 400); //* 카메라 포지션 x, y, z
  ...
  //^ div요소 
  // let elementObj2 = makeElementObject("div", 15, 20);  //* obj를 리턴받음
  ...
  // // elementObj.position.y = Math.random() * 600 - 300;  //* y축
  // // elementObj.position.z = Math.random() * 800 - 600;  //* z축
  // elementObj2.position.x = 22;  //* x축
  // elementObj2.position.y = -10;  //* y축
  // elementObj2.position.z = 55;  //* z축
